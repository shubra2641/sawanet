                ...
                <div class="dashboard-address-details">
                    ...
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
                            ...
                            <input class="form--control" type="text" placeholder="{{__('Type Your Area')}}" name="city" value="{{$user_details->city}}">
                        </div>
                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Your State')}} </label>
                            <input class="form--control" type="text" placeholder="{{__('Type Your State')}}" name="state" value="{{$user_details->state}}">
                        </div>
                        <div class="single-info-input margin-top-30">
